export BS=1; rm -r output_dir; CUDA_VISIBLE_DEVICES=0,1,2,3 PYTHONPATH=../../src USE_TF=0 deepspeed  \
./finetune_trainer.py --model_name_or_path "./templates/siamese-t5-xxl-v1_1-template" --output_dir output_dir --adam_eps 1e-06 \
...
--n_test 2000 --deepspeed ds_config_fp32.json