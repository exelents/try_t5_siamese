...
./finetune_trainer.py --model_name_or_path "./templates/siamese-t5-small-v1_1-template-2" --output_dir output_dir --adam_eps 1e-06 \
...
--eval_steps 25000 --label_smoothing_factor 0 --save_steps 10000 --src_lang en_XX --task translation \
