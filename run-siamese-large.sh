export BS=16; rm -r output_dir; CUDA_VISIBLE_DEVICES=0 PYTHONPATH=../../src USE_TF=0 deepspeed  \
./finetune_trainer.py --model_name_or_path "./templates/siamese-t5-large-v1_1-template" --output_dir output_dir --adam_eps 1e-06 \
...
--predict_with_generate --label_smoothing_factor 0 --eval_steps 25000 --save_steps 10000 --sortish_sampler --src_lang en_XX --task translation \
